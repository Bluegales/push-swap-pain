...
(function dartProgram() {
  ...
  var A = {JS_CONST: function JS_CONST() {
    ...
    _ChildrenElementList__addAll(_element, iterable) {
      var t1, t2;
      for (t1 = iterable.get$iterator(iterable), t2 = t1.$ti._precomputed1; t1.moveNext$0();)
        _element.appendChild(t2._as(t1.__interceptors$_current));
    },
    ...
    Stack$(_dom, left) {
      var t1 = A.List_List$filled(A.ListQueue__calculateCapacity(null), null, false, type$.nullable_Element);
      J.get$classes$x(_dom).add$1(0, "stack");
      return new A.Stack(_dom, new A.ListQueue(t1, type$.ListQueue_Element), left);
    },
    initButtons() {
      var t3, t4,
        t1 = document,
        t2 = t1.querySelector("#cmdPlay");
      if (t2 != null) {
        t2 = J.get$onClick$x(t2);
        t3 = t2.$ti;
        t4 = t3._eval$1("~(1)?")._as(new A.initButtons_closure());
        type$.nullable_void_Function._as(null);
        A._EventStreamSubscription$(t2._target, t2._eventType, t4, false, t3._precomputed1);
      }
      t2 = t1.querySelector("#cmdPause");
      if (t2 != null) {
        t2 = J.get$onClick$x(t2);
        t3 = t2.$ti;
        t4 = t3._eval$1("~(1)?")._as(new A.initButtons_closure0());
        type$.nullable_void_Function._as(null);
        A._EventStreamSubscription$(t2._target, t2._eventType, t4, false, t3._precomputed1);
      }
      t2 = t1.querySelector("#cmd1");
      if (t2 != null) {
        t2 = J.get$onClick$x(t2);
        t3 = t2.$ti;
        t4 = t3._eval$1("~(1)?")._as(new A.initButtons_closure1());
        type$.nullable_void_Function._as(null);
        A._EventStreamSubscription$(t2._target, t2._eventType, t4, false, t3._precomputed1);
      }
      t1 = t1.querySelector("#cmd1m");
      if (t1 != null) {
        t1 = J.get$onClick$x(t1);
        t2 = t1.$ti;
        t3 = t2._eval$1("~(1)?")._as(new A.initButtons_closure2());
        type$.nullable_void_Function._as(null);
        A._EventStreamSubscription$(t1._target, t1._eventType, t3, false, t2._precomputed1);
      }
    },
    main() {
      B.HtmlDocument_methods.addEventListener$2(document, "DOMContentLoaded", new A.main_closure());
    },
    addElements() {
      var count, _i, n, t2, t3, t4,
      ...
      for (t1 = type$.HtmlElement, _i = 0; _i < numbers.length; numbers.length === count || (0, A.throwConcurrentModificationError)(numbers), ++_i) {
        n = numbers[_i];
        t2 = document.createElement("div");
        t1._as(t2);
        t2.classList.add("element");
        t3 = t2.style;
        t4 = B.JSNumber_methods.toString$0((A.int_parse(n, null) + 1) / count * 100) + "%";
        t3.width = t4;
        t3 = t2.style;
        t4 = B.JSInt_methods.toString$0(A.int_parse(n, null) * 4) + "px";
        t3.top = t4;
        $.$get$stacks().appendChild(t2);
        t3 = $.$get$stack1();
        t3.add$2(0, t2, false);
        t3.updatePosition$0();
      }
    ...
    addCommands() {
      var commandString = A.Uri_parse(type$.Location._as(window.location).href).get$queryParameters().$index(0, "cmd");
      if (commandString == null)
        return 1;
      $.$get$commands().addCommandString$1(commandString);
      return 0;
    },
    executeCommand(cmd, update) {
      switch (cmd) {
        case B.eCommands_0:
          return $.$get$stack1().swap$1(false);
        case B.eCommands_1:
          return $.$get$stack2().swap$1(false);
        case B.eCommands_2:
          $.$get$stack1().swap$1(false);
          $.$get$stack2().swap$1(false);
          return 0;
        case B.eCommands_3:
          return $.$get$stack1().rotate$1(0, false);
        case B.eCommands_4:
          return $.$get$stack2().rotate$1(0, false);
        case B.eCommands_5:
          $.$get$stack1().rotate$1(0, false);
          $.$get$stack2().rotate$1(0, false);
          return 0;
        case B.eCommands_6:
          return $.$get$stack1().reverseRotate$1(false);
        case B.eCommands_7:
          return $.$get$stack2().reverseRotate$1(false);
        case B.eCommands_8:
          $.$get$stack1().reverseRotate$1(false);
          $.$get$stack2().reverseRotate$1(false);
          return 0;
        case B.eCommands_9:
          return $.$get$stack1().add$2(0, $.$get$stack2().remove$1(0, false), false);
        case B.eCommands_10:
          return $.$get$stack2().add$2(0, $.$get$stack1().remove$1(0, false), false);
        case B.eCommands_11:
          return 0;
      }
    },
    reverseCommand(cmd, update) {
      switch (cmd) {
        case B.eCommands_0:
        case B.eCommands_1:
        case B.eCommands_2:
          return A.executeCommand(cmd, false);
        case B.eCommands_3:
          return A.executeCommand(B.eCommands_6, false);
        case B.eCommands_4:
          return A.executeCommand(B.eCommands_7, false);
        case B.eCommands_5:
          return A.executeCommand(B.eCommands_8, false);
        case B.eCommands_6:
          return A.executeCommand(B.eCommands_3, false);
        case B.eCommands_7:
          return A.executeCommand(B.eCommands_4, false);
        case B.eCommands_8:
          return A.executeCommand(B.eCommands_5, false);
        case B.eCommands_9:
          return A.executeCommand(B.eCommands_10, false);
        case B.eCommands_10:
          return A.executeCommand(B.eCommands_9, false);
        case B.eCommands_11:
          return 0;
      }
    },
    printCommandList() {
      var commandString,
        printedList = document.querySelector("#commandList");
      if (printedList == null)
        return;
      commandString = A.Uri_parse(type$.Location._as(window.location).href).get$queryParameters().$index(0, "cmd");
      if (commandString == null)
        return;
      commandString = A.stringReplaceAllUnchecked(commandString, "a", "sa  ");
      commandString = A.stringReplaceAllUnchecked(commandString, "b", "sb  ");
      commandString = A.stringReplaceAllUnchecked(commandString, "c", "ss  ");
      commandString = A.stringReplaceAllUnchecked(commandString, "d", "ra  ");
      commandString = A.stringReplaceAllUnchecked(commandString, "e", "rb  ");
      commandString = A.stringReplaceAllUnchecked(commandString, "f", "rr  ");
      commandString = A.stringReplaceAllUnchecked(commandString, "g", "rra ");
      commandString = A.stringReplaceAllUnchecked(commandString, "h", "rrb ");
      commandString = A.stringReplaceAllUnchecked(commandString, "i", "rrr ");
      commandString = A.stringReplaceAllUnchecked(commandString, "j", "pa  ");
      J.setInnerHtml$1$x(printedList, '<font color="red"></font>' + A.stringReplaceAllUnchecked(commandString, "k", "pb  "));
    },
    colorCommands(i) {
      var t1, t2, original, first, second,
        printedList = document.querySelector("#commandList");
      if (printedList == null)
        return;
      t1 = J.getInterceptor$x(printedList);
      t2 = t1.get$innerHtml(printedList);
      if (t2 == null)
        original = null;
      else
        original = A.stringReplaceFirstUnchecked(t2, "</font>", "", 0);
      A.print(original);
      if (original == null)
        return;
      t2 = i * 4 + 18;
      first = B.JSString_methods.substring$2(original, 0, t2);
      second = B.JSString_methods.substring$1(original, t2);
      A.print(first + "</font>");
      t1.set$innerHtml(printedList, first + "</font>" + second);
    },
    eCommands: function eCommands(t0) {
      this._name = t0;
    },
    ...
    CommandList: function CommandList(t0) {
      this._commands = t0;
      this._push2dswap2dpain$_position = 0;
      this._playTimer = null;
    },
    CommandList_play_closure: function CommandList_play_closure() {
    },
    initButtons_closure: function initButtons_closure() {
    },
    initButtons_closure0: function initButtons_closure0() {
    },
    initButtons_closure1: function initButtons_closure1() {
    },
    initButtons_closure2: function initButtons_closure2() {
    },
  ...
  A.ListQueue.prototype = {
    ...
    addFirst$1(value) {
      ...
      _this._head = t1;
      B.JSArray_methods.$indexSet(t2, t1, value);
  ...
  A.SetMixin.prototype = {
    ...
    join$1(_, separator) {
      ...
      if (separator === "") {
        t2 = "";
        do
          t2 += A.S(t1._as(iterator._collection$_current));
        while (iterator.moveNext$0());
        t1 = t2;
      } else {
        t2 = "" + A.S(t1._as(iterator._collection$_current));
        for (; iterator.moveNext$0();)
          t2 = t2 + separator + A.S(t1._as(iterator._collection$_current));
        t1 = t2;
      }
      return t1.charCodeAt(0) == 0 ? t1 : t1;
    },
  ...
  A.Document.prototype = {
    createElement$1(receiver, tagName) {
      var t1 = receiver.createElement(tagName);
      return t1;
    }
  };
  ...
  A.eCommands.prototype = {
    toString$0(_) {
      return "eCommands." + this._name;
    }
  };
  A.Stack.prototype = {
    updatePosition$0() {
      var t1, t2, i, t3, t4, t5;
      for (t1 = this._children, t2 = t1.$ti._precomputed1, i = 0; i < (t1._tail - t1._head & t1._table.length - 1) >>> 0;) {
        A.RangeError_checkValidIndex(i, t1);
        t3 = t1._table;
        t4 = t3.length;
        t5 = (t1._head + i & t4 - 1) >>> 0;
        if (!(t5 < t4))
          return A.ioore(t3, t5);
        t5 = t2._as(t3[t5]).style;
        t3 = B.JSInt_methods.toString$0(i * 4) + "px";
        t5.top = t3;
        ++i;
      }
    },
    add$2(_, e, update) {
      ...
      if (e == null)
        return 1;
      t1 = this._children;
      t1._add$1(t1.$ti._precomputed1._as(e));
      t1 = this.left;
      A.print(t1);
      t2 = e.style;
      t2.left = t1;
    ...
    swap$1(update) {
      ...
      if (t1.get$length(t1) < 2)
        return 1;
      first = t1.removeFirst$0();
      second = t1.removeFirst$0();
      t1.addFirst$1(first);
      t1.addFirst$1(second);
      return 0;
    },
    rotate$1(_, update) {
      var t1 = this._children;
      if (t1.get$length(t1) < 2)
        return 1;
      t1._add$1(t1.$ti._precomputed1._as(t1.removeFirst$0()));
      return 0;
    },
    reverseRotate$1(update) {
      var t2, t3, t4, result,
        t1 = this._children;
      if (t1.get$length(t1) < 2)
        return 1;
      ...
      result = t1.$ti._precomputed1._as(t2[t3]);
      B.JSArray_methods.$indexSet(t2, t3, null);
      t1.addFirst$1(result);
      return 0;
    }
  };
  A.CommandList.prototype = {
    addCommandString$1(commands) {
      var firstCommand, t2, c,
        t1 = new A.Runes("a"),
        it = t1.get$iterator(t1);
      if (!it.moveNext$0())
        A.throwExpression(A.IterableElementError_noElement());
      firstCommand = it.get$current();
      for (t1 = new A.RuneIterator(commands), t2 = this._commands; t1.moveNext$0();) {
        c = t1._currentCodePoint - firstCommand;
        if (c < 0 || c > 10)
          return 1;
        if (!(c >= 0 && c < 12))
          return A.ioore(B.List_izR, c);
        B.JSArray_methods.add$1(t2, B.List_izR[c]);
      }
      return 0;
    },
    play$1(_, speed) {
      var _this = this,
        t1 = _this._push2dswap2dpain$_position;
      if (t1 >= _this._commands.length && true)
        _this.execute$1(-t1);
      t1 = _this._playTimer;
      if (t1 != null)
        t1.cancel$0();
      _this._playTimer = A.Timer_Timer$periodic(speed, new A.CommandList_play_closure());
    },
    execute$1(count) {
      var _this = this,
        t1 = _this._commands,
      ...
      if (t2 === 0)
        return 1;
      if (count > 0 && _this._push2dswap2dpain$_position >= t2)
        return 2;
      if (count < 0 && _this._push2dswap2dpain$_position <= 0)
        return 2;
      while (true) {
        if (!(count > 0 && _this._push2dswap2dpain$_position < t1.length))
          break;
        t2 = _this._push2dswap2dpain$_position;
        if (!(t2 >= 0 && t2 < t1.length))
          return A.ioore(t1, t2);
        if (A.executeCommand(t1[t2], false) !== 0)
          B.JSArray_methods.$indexSet(t1, _this._push2dswap2dpain$_position, B.eCommands_11);
        --count;
        ++_this._push2dswap2dpain$_position;
      }
      while (true) {
        if (!(count < 0 && _this._push2dswap2dpain$_position > 0))
          break;
        ...
        if (!(t2 >= 0 && t2 < t1.length))
          return A.ioore(t1, t2);
        if (A.reverseCommand(t1[t2], false) !== 0)
          B.JSArray_methods.$indexSet(t1, _this._push2dswap2dpain$_position, B.eCommands_11);
      }
      $.$get$stack1().updatePosition$0();
      $.$get$stack2().updatePosition$0();
      A.colorCommands(_this._push2dswap2dpain$_position);
      return 0;
    }
  };
  A.CommandList_play_closure.prototype = {
    call$1(timer) {
      var t1;
      type$.Timer._as(timer);
      t1 = A.LinkedHashSet_LinkedHashSet$_empty(type$.void);
      if ($.$get$commands().execute$1(1) !== 0)
        t1.add$1(0, timer.cancel$0());
      return t1;
    },
    $signature: 27
  };
  A.initButtons_closure.prototype = {
    call$1($event) {
      type$.MouseEvent._as($event);
      $.$get$commands().play$1(0, new A.Duration(200000));
    },
    $signature: 1
  };
  A.initButtons_closure0.prototype = {
    call$1($event) {
      var t1;
      type$.MouseEvent._as($event);
      t1 = $.$get$commands()._playTimer;
      if (t1 != null)
        t1.cancel$0();
    },
    $signature: 1
  };
  A.initButtons_closure1.prototype = {
    call$1($event) {
      type$.MouseEvent._as($event);
      $.$get$commands().execute$1(1);
    },
    $signature: 1
  };
  A.initButtons_closure2.prototype = {
    call$1($event) {
      type$.MouseEvent._as($event);
      $.$get$commands().execute$1(-1);
    },
  ...
  A.main_closure.prototype = {
    call$1(e) {
      var wrapper;
      type$.Event._as(e);
      wrapper = document.querySelector(".stackWrapper");
      if (wrapper != null)
        wrapper.appendChild($.$get$stacks());
      A.printCommandList();
      A.addElements();
      A.addCommands();
      A.initButtons();
  ...
  (function inheritance() {
    ...
    _inheritMany(A.Object, [A.JS_CONST, J.Interceptor, J.ArrayIterator, A.Error, A._ListBase_Object_ListMixin, A.Iterable, A.ListIterator, A.Iterator, A.FixedLengthListMixin, A.UnmodifiableListMixin, A.ConstantMap, A.TypeErrorDecoder, A.NullThrownFromJavaScriptException, A._StackTrace, A.Closure, A.MapMixin, A.LinkedHashMapCell, A.LinkedHashMapKeyIterator, A.JSSyntaxRegExp, A.StringMatch, A._StringAllMatchesIterator, A.Rti, A._FunctionParameters, A._TimerImpl, A.AsyncError, A._FutureListener, A._Future, A._AsyncCallbackEntry, A.Stream, A.StreamSubscription, A.StreamTransformerBase, A._Zone, A.__SetBase_Object_SetMixin, A._LinkedHashSetCell, A._LinkedHashSetIterator, A.ListMixin, A._UnmodifiableMapMixin, A.MapView, A._ListQueueIterator, A.SetMixin, A._SetBase_Object_SetMixin, A.Codec, A._Utf8Decoder, A.Duration, A._Enum, A.OutOfMemoryError, A.StackOverflowError, A._Exception, A.FormatException, A.Null, A._StringStackTrace, A.RuneIterator, A.StringBuffer, A._Uri, A.UriData, A._SimpleUri, A.CssStyleDeclarationBase, A.EventStreamProvider, A._Html5NodeValidator, A.ImmutableListMixin, A.NodeValidatorBuilder, A._SimpleNodeValidator, A._SvgNodeValidator, A.FixedSizeListIterator, A._SameOriginUriPolicy, A._ValidatingTreeSanitizer, A.Stack, A.CommandList]);
    ...
    _inheritMany(A.Iterable, [A.EfficientLengthIterable, A.MappedIterable, A.WhereIterable, A.Runes]);
    ...
    _inheritMany(A.Closure, [A.Closure0Args, A.Closure2Args, A.TearOffClosure, A.initHooks_closure, A.initHooks_closure1, A._AsyncRun__initializeScheduleImmediate_internalCallback, A._AsyncRun__initializeScheduleImmediate_closure, A._Future__propagateToListeners_handleWhenCompleteCallback_closure, A.Stream_length_closure, A._RootZone_bindUnaryCallbackGuarded_closure, A._createTables_setChars, A._createTables_setRange, A.Element_Element$html_closure, A._EventStreamSubscription_closure, A.NodeValidatorBuilder_allowsElement_closure, A.NodeValidatorBuilder_allowsAttribute_closure, A._SimpleNodeValidator_closure, A._SimpleNodeValidator_closure0, A._TemplatingNodeValidator_closure, A.CssClassSetImpl_add_closure, A.FilteredElementList__iterable_closure, A.FilteredElementList__iterable_closure0, A.CommandList_play_closure, A.initButtons_closure, A.initButtons_closure0, A.initButtons_closure1, A.initButtons_closure2, A.main_closure]);
    _inheritMany(A.TearOffClosure, [A.StaticClosure, A.BoundClosure]);
    _inherit(A._AssertionError, A.AssertionError);
    _inherit(A.MapBase, A.MapMixin);
    _inheritMany(A.MapBase, [A.JsLinkedHashMap, A._AttributeMap]);
    _inheritMany(A.Closure2Args, [A.initHooks_closure0, A.MapBase_mapToString_closure, A.Uri_splitQueryString_closure, A.Uri__parseIPv4Address_error, A.Uri_parseIPv6Address_error, A.Uri_parseIPv6Address_parseHex, A._createTables_build, A._ValidatingTreeSanitizer_sanitizeTree_walk]);
  ...
  var init = {
    ...
    mangledNames: {},
    types: ["~()", "~(MouseEvent)", "Null()", "~(~())", "@()", "~(Uint8List,String,int)", "bool(Node)", "bool(NodeValidator)", "bool(String)", "bool(Element,String,String,_Html5NodeValidator)", "@(@)", "@(@,String)", "@(String)", "Null(@)", "Null(~())", "_Future<@>(@)", "~(Object?,Object?)", "Map<String,String>(Map<String,String>,String)", "~(String,int)", "~(String,int?)", "int(int,int)", "Uint8List(@,@)", "~(Event)", "String(String)", "~(Node,Node?)", "bool(Set<String>)", "Element(Node)", "~(Timer)", "Null(Event)"],
    interceptorsByTag: null,
    leafTags: null,
    arrayRti: Symbol("$ti")
  };
  A._Universe_addRules(init.typeUniverse, JSON.parse('{"PlainJavaScriptObject":"LegacyJavaScriptObject","UnknownJavaScriptObject":"LegacyJavaScriptObject","JavaScriptFunction":"LegacyJavaScriptObject","AbortPaymentEvent":"Event","ExtendableEvent":"Event","AElement":"SvgElement","GraphicsElement":"SvgElement","AudioElement":"HtmlElement","MediaElement":"HtmlElement","ShadowRoot":"Node","DocumentFragment":"Node","XmlDocument":"Document","Window":"EventTarget","PointerEvent":"MouseEvent","CompositionEvent":"UIEvent","CDataSection":"CharacterData","Text":"CharacterData","HtmlFormControlsCollection":"HtmlCollection","JSBool":{"bool":[]},"JSArray":{"List":["1"],"Iterable":["1"]},"JSUnmodifiableArray":{"JSArray":["1"],"List":["1"],"Iterable":["1"]},"ArrayIterator":{"Iterator":["1"]},"JSNumber":{"num":[]},"JSInt":{"int":[],"num":[]},"JSNumNotInt":{"num":[]},"JSString":{"String":[],"Pattern":[]},"LateError":{"Error":[]},"CodeUnits":{"ListMixin":["int"],"UnmodifiableListMixin":["int"],"List":["int"],"Iterable":["int"],"ListMixin.E":"int","UnmodifiableListMixin.E":"int"},"EfficientLengthIterable":{"Iterable":["1"]},"ListIterable":{"Iterable":["1"]},"ListIterator":{"Iterator":["1"]},"MappedIterable":{"Iterable":["2"],"Iterable.E":"2"},"MappedIterator":{"Iterator":["2"]},"MappedListIterable":{"ListIterable":["2"],"Iterable":["2"],"ListIterable.E":"2","Iterable.E":"2"},"WhereIterable":{"Iterable":["1"],"Iterable.E":"1"},"WhereIterator":{"Iterator":["1"]},"UnmodifiableListBase":{"ListMixin":["1"],"UnmodifiableListMixin":["1"],"List":["1"],"Iterable":["1"]},"ConstantMap":{"Map":["1","2"]},"ConstantStringMap":{"ConstantMap":["1","2"],"Map":["1","2"]},"NullError":{"TypeError":[],"Error":[]},"JsNoSuchMethodError":{"Error":[]},"UnknownJsTypeError":{"Error":[]},"_StackTrace":{"StackTrace":[]},"Closure":{"Function":[]},"Closure0Args":{"Function":[]},"Closure2Args":{"Function":[]},"TearOffClosure":{"Function":[]},"StaticClosure":{"Function":[]},"BoundClosure":{"Function":[]},"RuntimeError":{"Error":[]},"_AssertionError":{"Error":[]},"JsLinkedHashMap":{"MapMixin":["1","2"],"Map":["1","2"],"MapMixin.K":"1","MapMixin.V":"2"},"LinkedHashMapKeyIterable":{"Iterable":["1"],"Iterable.E":"1"},"LinkedHashMapKeyIterator":{"Iterator":["1"]},"JSSyntaxRegExp":{"Pattern":[]},"StringMatch":{"Match":[]},"_StringAllMatchesIterator":{"Iterator":["Match"]},"NativeTypedArray":{"JavaScriptIndexingBehavior":["1"]},"NativeTypedArrayOfInt":{"ListMixin":["int"],"JavaScriptIndexingBehavior":["int"],"List":["int"],"Iterable":["int"],"FixedLengthListMixin":["int"]},"NativeInt8List":{"ListMixin":["int"],"JavaScriptIndexingBehavior":["int"],"List":["int"],"Iterable":["int"],"FixedLengthListMixin":["int"],"ListMixin.E":"int"},"NativeUint8List":{"ListMixin":["int"],"Uint8List":[],"JavaScriptIndexingBehavior":["int"],"List":["int"],"Iterable":["int"],"FixedLengthListMixin":["int"],"ListMixin.E":"int"},"_Error":{"Error":[]},"_TypeError":{"TypeError":[],"Error":[]},"_Future":{"Future":["1"]},"_TimerImpl":{"Timer":[]},"AsyncError":{"Error":[]},"_Zone":{"Zone":[]},"_RootZone":{"_Zone":[],"Zone":[]},"_LinkedHashSet":{"SetMixin":["1"],"Set":["1"],"Iterable":["1"],"SetMixin.E":"1"},"_LinkedHashSetIterator":{"Iterator":["1"]},"ListBase":{"ListMixin":["1"],"List":["1"],"Iterable":["1"]},"MapBase":{"MapMixin":["1","2"],"Map":["1","2"]},"MapMixin":{"Map":["1","2"]},"MapView":{"Map":["1","2"]},"UnmodifiableMapView":{"_UnmodifiableMapView_MapView__UnmodifiableMapMixin":["1","2"],"MapView":["1","2"],"_UnmodifiableMapMixin":["1","2"],"Map":["1","2"]},"ListQueue":{"ListIterable":["1"],"Queue":["1"],"Iterable":["1"],"ListIterable.E":"1","Iterable.E":"1"},"_ListQueueIterator":{"Iterator":["1"]},"SetBase":{"SetMixin":["1"],"Set":["1"],"Iterable":["1"]},"_SetBase":{"SetMixin":["1"],"Set":["1"],"Iterable":["1"]},"Base64Codec":{"Codec":["List<int>","String"]},"Base64Encoder":{"Converter":["List<int>","String"]},"Encoding":{"Codec":["String","List<int>"]},"Utf8Codec":{"Codec":["String","List<int>"]},"Utf8Decoder":{"Converter":["List<int>","String"]},"int":{"num":[]},"List":{"Iterable":["1"]},"Set":{"Iterable":["1"]},"String":{"Pattern":[]},"AssertionError":{"Error":[]},"TypeError":{"Error":[]},"NullThrownError":{"Error":[]},"ArgumentError":{"Error":[]},"RangeError":{"Error":[]},"IndexError":{"Error":[]},"UnsupportedError":{"Error":[]},"UnimplementedError":{"Error":[]},"StateError":{"Error":[]},"ConcurrentModificationError":{"Error":[]},"OutOfMemoryError":{"Error":[]},"StackOverflowError":{"Error":[]},"CyclicInitializationError":{"Error":[]},"_StringStackTrace":{"StackTrace":[]},"Runes":{"Iterable":["int"],"Iterable.E":"int"},"RuneIterator":{"Iterator":["int"]},"StringBuffer":{"StringSink":[]},"_Uri":{"Uri":[]},"_SimpleUri":{"Uri":[]},"_DataUri":{"Uri":[]},"Element":{"Node":[],"EventTarget":[]},"MouseEvent":{"Event":[]},"Node":{"EventTarget":[]},"_Html5NodeValidator":{"NodeValidator":[]},"HtmlElement":{"Element":[],"Node":[],"EventTarget":[]},"AnchorElement":{"HtmlElement":[],"Element":[],"Node":[],"EventTarget":[]},"AreaElement":{"HtmlElement":[],"Element":[],"Node":[],"EventTarget":[]},"BaseElement":{"HtmlElement":[],"Element":[],"Node":[],"EventTarget":[]},"BodyElement":{"HtmlElement":[],"Element":[],"Node":[],"EventTarget":[]},"CharacterData":{"Node":[],"EventTarget":[]},"Document":{"Node":[],"EventTarget":[]},"FormElement":{"HtmlElement":[],"Element":[],"Node":[],"EventTarget":[]},"HtmlCollection":{"ListMixin":["Node"],"ImmutableListMixin":["Node"],"List":["Node"],"JavaScriptIndexingBehavior":["Node"],"Iterable":["Node"],"ImmutableListMixin.E":"Node","ListMixin.E":"Node"},"HtmlDocument":{"Node":[],"EventTarget":[]},"_ChildNodeListLazy":{"ListMixin":["Node"],"List":["Node"],"Iterable":["Node"],"ListMixin.E":"Node"},"NodeList":{"ListMixin":["Node"],"ImmutableListMixin":["Node"],"List":["Node"],"JavaScriptIndexingBehavior":["Node"],"Iterable":["Node"],"ImmutableListMixin.E":"Node","ListMixin.E":"Node"},"SelectElement":{"HtmlElement":[],"Element":[],"Node":[],"EventTarget":[]},"TableElement":{"HtmlElement":[],"Element":[],"Node":[],"EventTarget":[]},"TableRowElement":{"HtmlElement":[],"Element":[],"Node":[],"EventTarget":[]},"TableSectionElement":{"HtmlElement":[],"Element":[],"Node":[],"EventTarget":[]},"TemplateElement":{"HtmlElement":[],"Element":[],"Node":[],"EventTarget":[]},"UIEvent":{"Event":[]},"_Attr":{"Node":[],"EventTarget":[]},"_NamedNodeMap":{"ListMixin":["Node"],"ImmutableListMixin":["Node"],"List":["Node"],"JavaScriptIndexingBehavior":["Node"],"Iterable":["Node"],"ImmutableListMixin.E":"Node","ListMixin.E":"Node"},"_AttributeMap":{"MapMixin":["String","String"],"Map":["String","String"]},"_ElementAttributeMap":{"MapMixin":["String","String"],"Map":["String","String"],"MapMixin.K":"String","MapMixin.V":"String"},"_ElementCssClassSet":{"SetMixin":["String"],"Set":["String"],"Iterable":["String"],"SetMixin.E":"String"},"_EventStream":{"Stream":["1"]},"_ElementEventStreamImpl":{"_EventStream":["1"],"Stream":["1"]},"NodeValidatorBuilder":{"NodeValidator":[]},"_SimpleNodeValidator":{"NodeValidator":[]},"_TemplatingNodeValidator":{"NodeValidator":[]},"_SvgNodeValidator":{"NodeValidator":[]},"FixedSizeListIterator":{"Iterator":["1"]},"_SameOriginUriPolicy":{"UriPolicy":[]},"_ValidatingTreeSanitizer":{"NodeTreeSanitizer":[]},"CssClassSetImpl":{"SetMixin":["String"],"Set":["String"],"Iterable":["String"]},"FilteredElementList":{"ListMixin":["Element"],"List":["Element"],"Iterable":["Element"],"ListMixin.E":"Element"},"ScriptElement0":{"SvgElement":[],"Element":[],"Node":[],"EventTarget":[]},"AttributeClassSet":{"SetMixin":["String"],"Set":["String"],"Iterable":["String"],"SetMixin.E":"String"},"SvgElement":{"Element":[],"Node":[],"EventTarget":[]},"Uint8List":{"List":["int"],"Iterable":["int"]}}'));
  A._Universe_addErasedTypes(init.typeUniverse, JSON.parse('{"EfficientLengthIterable":1,"UnmodifiableListBase":1,"NativeTypedArray":1,"StreamSubscription":1,"StreamTransformerBase":2,"ListBase":1,"MapBase":2,"SetBase":1,"_SetBase":1,"_ListBase_Object_ListMixin":1,"_SetBase_Object_SetMixin":1,"__SetBase_Object_SetMixin":1}'));
  var string$ = {
  ...
  var type$ = (function rtii() {
    ...
    return {
      ...
      JSArray_eCommands: findType("JSArray<eCommands>"),
      JSArray_int: findType("JSArray<int>"),
      JSNull: findType("JSNull"),
      JavaScriptFunction: findType("JavaScriptFunction"),
      JavaScriptIndexingBehavior_dynamic: findType("JavaScriptIndexingBehavior<@>"),
      ListQueue_Element: findType("ListQueue<Element>"),
...
;
    ...
    B.eCommands_0 = new A.eCommands("swap1");
    B.eCommands_1 = new A.eCommands("swap2");
    B.eCommands_2 = new A.eCommands("swapBoth");
    B.eCommands_3 = new A.eCommands("rotate1");
    B.eCommands_4 = new A.eCommands("rotate2");
    B.eCommands_5 = new A.eCommands("rotateBoth");
    B.eCommands_6 = new A.eCommands("reverseRotate1");
    B.eCommands_7 = new A.eCommands("reverseRotate2");
    B.eCommands_8 = new A.eCommands("reverseRotateBoth");
    B.eCommands_9 = new A.eCommands("push1");
    B.eCommands_10 = new A.eCommands("push2");
    B.eCommands_11 = new A.eCommands("none");
    B.List_izR = A._setArrayType(makeConstList([B.eCommands_0, B.eCommands_1, B.eCommands_2, B.eCommands_3, B.eCommands_4, B.eCommands_5, B.eCommands_6, B.eCommands_7, B.eCommands_8, B.eCommands_9, B.eCommands_10, B.eCommands_11]), type$.JSArray_eCommands);
  ...
  (function lazyInitializers() {
    ...
    _lazyFinal($, "stacks", "$get$stacks", () => B.HtmlDocument_methods.createElement$1(A.document(), "div"));
    _lazyFinal($, "stack1", "$get$stack1", () => A.Stack$($.$get$stacks(), "0px"));
    _lazyFinal($, "stack2", "$get$stack2", () => A.Stack$($.$get$stacks(), "110%"));
    _lazyFinal($, "commands", "$get$commands", () => new A.CommandList(A._setArrayType([], type$.JSArray_eCommands)));
  })();
